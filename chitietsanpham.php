                ...
                <div class="row product_d_price">
                    ...
                    <div class="col-lg-6">
                        <div class="product_details_text">
                            ...
                            <form  action="themcart.php" method="GET">
                            <div class="quantity_box">
                                <label for="quantity">Số lượng :</label>
                                <input type="text" placeholder="1" id="quantity" name="solog">
                                <input type="hidden" name="id" value="<?php echo($dataBanh['ma_banh'])?>">
                            </div>
                           <button class="pest_btn" type="sumit">Thêm giỏ</button>
                           </form>
                        </div>
                    </div>
                </div>
