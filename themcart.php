<?php
   include('./connectDB.php');
    ...
    if(isset($_GET['id'])){
        //0:Đang xử lý, 1:Đã xác nhận, 2:Đang giao hàng, 3:Đã giao hàng và thanh toán
        ...
        if(isset($_GET['solog']))
        {
            ...
            $solog=(int)$_GET['solog'];
            if($solog==0)
                $solog=1;
        }
        $sqlAddItem= "INSERT INTO `chitiet_dh`(`ma_dh`, `ma_banh`, `soluong`, `tonggia`) VALUES (?,?,?,?)";
        ...
        $arrItem = array($idGio,$mabanh,$solog,$dongia);
